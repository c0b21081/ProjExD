...
# game constants
MAX_SHOTS = 50  # most player bullets onscreen # 3
...
class Score(pg.sprite.Sprite): # 4
...
def main(winstyle=0):
    ...
    img = load_image("6.png") # kokaton load
